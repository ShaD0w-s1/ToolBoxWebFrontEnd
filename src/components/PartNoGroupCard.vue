...
<style scoped>
.pnc-card { border: 1px solid #dde2ec; border-radius: 10px; background: #fff; margin-bottom: 10px; overflow: hidden; }
...
.pnc-name { font-size: 13px; color: #4a5160; }
.pnc-count { margin-left: auto; font-size: 12px; color: #98a2b3; }
...
.pnc-type { font-size: 13px; color: #4a5160; padding: 4px 8px; background: #f4f6fb; border-radius: 6px; min-height: 24px; }
.pnc-qty { width: 100%; min-height: 30px; padding: 4px 6px; border: 1px solid #d7dbe4; border-radius: 6px; font-size: 13px; box-sizing: border-box; }
.pnc-del { width: 26px; height: 26px; padding: 0; border: 1px solid #f2cdcd; border-radius: 6px; background: #fdecec; color: #b53a3a; font-size: 16px; line-height: 1; cursor: pointer; }
.pnc-del:hover { background: #f9dcdc; }
.pnc-note { min-height: 30px; padding: 4px 7px; border: 1px solid #d7dbe4; border-radius: 6px; font-size: 12px; resize: none; overflow: hidden; font-family: inherit; line-height: 1.4; box-sizing: border-box; width: 100%; }
</style>
