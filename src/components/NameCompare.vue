...
.nc-col { background: var(--n0); padding: 8px 10px; min-height: 36px; display: flex; align-items: center; }
...
.nc-cat-input { border: none; background: var(--n0); padding: 8px 10px; font-size: var(--fs-13); font-weight: 700; color: var(--blue-strong); }
...
.nc-add-row button { border: none; background: var(--n0); padding: 6px 8px; font-size: var(--fs-12); color: var(--blue-strong); }
